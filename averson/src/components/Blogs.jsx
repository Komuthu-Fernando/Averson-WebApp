...
function Blogs() {
	...
	useEffect(() => {
		const fetchBlogs = async () => {
			try {
				...
				setBlogs(data.blogs); // Set the fetched blogs to state
			} catch (error) {
	...
	return (
		<div className="m-20 mt-40">
			...
			<div className="grid grid-cols-4 gap-2 flex flex-col md:flex-row justify-around">
				{randomBlogs.map((blog) => (
					<div key={blog.id} className="blog-item max-w-xs">
